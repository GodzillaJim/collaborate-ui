...
function Facebook () {
  ...
  return (
    <div>
      <FacebookLogin fields="first_name, last_name, email, picture" className="btn btn-block btn-info" appId="579040103864510" autoLoad onProfileSuccess={handleProfileSuccess} onFail={handleError} onSuccess={handleSuccess} />
    </div>
  )
}
